...
if __name__ == '__main__':
    ...
    print("Expected: jgnnq")
    print(f"Actual: {plaintext.get_message_text_encrypted()}")

    print()

    plaintext = PlaintextMessage('abc', 3)
    print("Expected: def")
    print(f"Actual: {plaintext.get_message_text_encrypted()}")

    print()

    cipher = CiphertextMessage('jgnnq')
    print("Expected: hello")
    print(f"Actual: {cipher.decrypt_message()}")

    print()

    cipher = CiphertextMessage('cdef')
    print("Expected: abcd")
    print(f"Actual: {cipher.decrypt_message()}")

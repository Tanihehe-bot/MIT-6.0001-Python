    ...
    while guesses_remaining > 0 and not is_word_guessed(secret_word, letters_guessed):
        ...
        if not guess.isalpha() or len(guess) != 1:
            if warnings_remaining > 0:
                ...
                guesses_remaining -= 1
                print(f"Oops! That is not a valid letter. You lost one guess: {get_guessed_word(secret_word, letters_guessed)}")
            ...
            if warnings_remaining > 0:
                ...
                guesses_remaining -= 1
                print(f"Oops! You've already guessed that letter. You lost one guess: {get_guessed_word(secret_word, letters_guessed)}")
